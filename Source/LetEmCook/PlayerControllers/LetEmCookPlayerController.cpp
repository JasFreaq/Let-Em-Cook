...
void ALetEmCookPlayerController::Login()
{
	/*
...
void ALetEmCookPlayerController::HandleLoginCompleted(int32 LocalUserNum, bool bWasSuccessful,
...
void ALetEmCookPlayerController::FindSessions(FName SearchKey, FString SearchValue)
{
...
void ALetEmCookPlayerController::JoinSession()
{
	// Join the session. 
